...
app.get('/uploadaudioDKE14462/:projectName/:id', function (req, res) {
    res.sendFile(__dirname + "/audioE14462DK.html");
});
...
app.get("/dp/uploadaudioen/:tx/:projectName/:id", (req, res) => {
   ...
   app.get("/dp/uploadaudioat/:tx/:projectName/:id", (req, res) => {
    var text = req.params["tx"];
    text = text.slice(1,-1);
    text = text.replace(/@/g, "/");
    text = decodeURIComponent(text);
    res.render("dpaudioat", {text: text});
   });
